...
<section class="home">
    ...
    <div class="content">
        <Card class="card" style="margin-top: 1vh;">
            <div>
                <h4>Pick a date</h4>
                <Select v-model="date" placeholder="Please Select a date" prefix="ios-calendar-outline" style="width:100%; margin-top: 1vh;">
                    <Option v-for="item in dateList" :key="item.value" :value="item.value">
                        {{ item.label }}
                    </Option>
                </Select>
            </div>
        ...
        <Card class="card" style="margin-top: 2vh;">
            <div>
                <h4>Pick a Time</h4>
                <Select v-model="time" placeholder="Please Select a Time" prefix="ios-time-outline" style="width:100%; margin-top: 1vh;">
        ...
        <Card class="card" style="margin-top: 2vh;">
            ...
            <p class="info">
                If you submitted your email we will contact you via email, if you submit your phone (please include country code) we will contact you through a text message.
            </p>
            <div style="margin-top: 1vh">
    ...
    <Modal v-model="bookingModel" class-name="vertical-center-modal">
        ...
        <div>
            <h3 class="success--message">
                You have made a booking, someone from Orentio will reach you out
            </h3>
            <CellGroup>
        ...
        <div slot="footer">
            <Button type="error" size="large" @click="goBack()">
                Thanks
            </Button>
        </div>
    </Modal>
